        ...
        <div className='flex flex-col gap-8'>
            <div className='flex flex-row w-70 gap-6 border-dotted border-b-3 border-b-blue-400 pb-2'>
                <div className='flex gap-2 '>
                    <h1 className='text-3xl -semibold font-display'>140</h1>
            ...
            <div className='flex flex-row w-70 gap-6 border-dotted border-b-3 border-b-blue-400 pb-2'>
                <div className='flex gap-2 '>
                    <h1 className='text-3xl  font-semibold font-display'>98</h1>
            ...
            <div className='flex flex-row w-70 gap-6 border-dotted border-b-3 border-b-blue-400  pb-2'>
                <div className='flex gap-2 '>
                    <h1 className='text-3xl  font-semibold font-display'>3</h1>
                    <Plus className='size-8 text-blue-400 strokeWidth={3}' />
                </div>
